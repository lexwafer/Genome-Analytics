...
# 23-mer
module load gnu/9.1.0 #left off here 2.23.24 12:02 pm
...
module load R/3.6.0
# For Illumina 23-mer
Rscript /fs/scratch/PAS2658/Alexis/Assemblyy/Software/genomescope/genomescope.R  /fs/scratch/PAS2658/Alexis/Assembly/Illumina/kmer_analysis/Illumina_k23.hist 23 100 K-mer_s23
```
...
cd kmer_analysis
/fs/scratch/PAS2658/Alexis/Assembly/Software/kmergenie-1.7051/kmergenie ../SRR11481813_1.fastq.gz -s 2 -o Nanopore
```
